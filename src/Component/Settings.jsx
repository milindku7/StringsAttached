  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      const fetchResponse = await fetch(
        `https://stringsattached.online/hci/api/api/claem/file-uploads?uploaderID=${userID}`,
        {
          method: "GET",
          headers: {
      ...
      const deleteResponse = await fetch(
        `https://stringsattached.online/hci/api/api/claem/file-uploads/${latestImage.id}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${authToken}`,
      ...
      const reviewerData = await Promise.all(
        reviews.map(async (review) => {
          const reviewerRes = await fetch(
            `https://stringsattached.online/hci/api/api/claem/users/${review.reviewerID}`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
...
const fetchFollowedUsers = async () => {
  ...
  try {
    const response = await fetch(
      `https://stringsattached.online/hci/api/api/claem/connections?fromUserID=${userID}`,
      {
        method: "GET",
        headers: {
          Authorization: `Bearer ${token}`,
    ...
    const pendingFetches = pendings.map(async (conn) => {
      try {
        const res = await fetch(
          `https://stringsattached.online/hci/api/api/claem/users/${conn.toUserID}`,
          {
            method: "GET",
            headers: {
              Authorization: `Bearer ${token}`,
...
const deleteAccount = async () => {
  ...
  try {
      const response = await fetch(
          `https://stringsattached.online/hci/api/api/claem/users/${storedUserID}?relatedObjectsAction=delete`, 
          {
              method: "DELETE",
              headers: {
                  "Authorization": `Bearer ${token}`,  
...
const fetchLatestProfilePicture = useCallback(async () => {
    ...
    try {
        const response = await fetch(
            `https://stringsattached.online/hci/api/api/claem/file-uploads?uploaderID=${userID}&take=1`,
            {
                method: "GET",
                headers: {
                    "Authorization": `Bearer ${authToken}`,
...
const fetchUserProfile = useCallback(async () => {
  ...
  try {
      const response = await fetch(
          `https://stringsattached.online/hci/api/api/claem/users/${storedUserID}`,
          {
              method: "GET",
              headers: {
...
//
//       const deleteResponse = await fetch(
//         `https://stringsattached.online/hci/api/api/claem/posts/${post.id}`,
//         {
//           method: "DELETE",
//           headers: {
//             "Authorization": `Bearer ${authToken}`,
...
const updateAge = async () => {
  ...
  const deletePost = async (postId, fileId = null) => {
    ...
    try {
      const deleteResponse = await fetch(
        `https://stringsattached.online/hci/api/api/claem/posts/${postId}`,
        {
          method: "DELETE",
          headers: {
            "Authorization": `Bearer ${authToken}`,
      ...
      if (fileId) {
        const fileDeleteResponse = await fetch(
          `https://stringsattached.online/hci/api/api/claem/file-uploads/${fileId}`,
          {
            method: "DELETE",
            headers: {
              "Authorization": `Bearer ${authToken}`,

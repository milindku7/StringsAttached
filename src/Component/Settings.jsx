  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      const fetchResponse = await fetch(
        `https://stringsattached.online/hci/api/api/default/file-uploads?uploaderID=${userID}`,
        {
          method: "GET",
          headers: {
      ...
      const deleteResponse = await fetch(
        `https://stringsattached.online/hci/api/api/default/file-uploads/${latestImage.id}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${authToken}`,
      ...
      const ratingsWithNames = await Promise.all(
        ratingsArray.map(async (r) => {
          ...
          const reactorRes = await fetch(
            `https://stringsattached.online/hci/api/api/default/users/${r.reactorID}`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
      ...
      const reviewerData = await Promise.all(
        reviews.map(async (review) => {
          const reviewerRes = await fetch(
            `https://stringsattached.online/hci/api/api/default/users/${review.reviewerID}`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
...
const fetchFollowedUsers = async () => {
  ...
  try {
    const response = await fetch(
      `https://stringsattached.online/hci/api/api/default/connections?fromUserID=${userID}`,
      {
        method: "GET",
        headers: {
          Authorization: `Bearer ${token}`,
    ...
    const pendingFetches = pendings.map(async (conn) => {
      try {
        const res = await fetch(
          `https://stringsattached.online/hci/api/api/default/users/${conn.toUserID}`,
          {
            method: "GET",
            headers: {
              Authorization: `Bearer ${token}`,
  ...
  const fetchUserPosts = async () => {
    ...
    try {
      const response = await fetch(
        `https://stringsattached.online/hci/api/api/default/posts?authorID=${userID}`,
        {
          method: "GET",
          headers: {
            "Authorization": `Bearer ${authToken}`,
...
const deleteAccount = async () => {
  ...
  try {
      const response = await fetch(
          `https://stringsattached.online/hci/api/api/default/users/${storedUserID}?relatedObjectsAction=delete`, 
          {
              method: "DELETE",
              headers: {
                  "Authorization": `Bearer ${token}`,  
...
const fetchUserProfile = useCallback(async () => {
  ...
  try {
      const response = await fetch(
          `https://stringsattached.online/hci/api/api/default/users/${storedUserID}`,
          {
              method: "GET",
              headers: {
...
if (!postContent.trim()) {
  ...
  try {
    ...
    const response = await fetch(
      "https://stringsattached.online/hci/api/api/default/posts",
      {
        method: "POST",
        headers: {
          "Authorization": `Bearer ${authToken}`,
...
//
//       const deleteResponse = await fetch(
//         `https://stringsattached.online/hci/api/api/default/posts/${post.id}`,
//         {
//           method: "DELETE",
//           headers: {
//             "Authorization": `Bearer ${authToken}`,
...
const updateAge = async () => {
  ...
  const deletePost = async (postId, fileId = null) => {
    ...
    try {
      const deleteResponse = await fetch(
        `https://stringsattached.online/hci/api/api/default/posts/${postId}`,
        {
          method: "DELETE",
          headers: {
            "Authorization": `Bearer ${authToken}`,

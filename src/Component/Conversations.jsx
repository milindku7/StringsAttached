...
const Conversations = () => {
    ...
    const fetchAllUsers = useCallback(async () => {
        ...
        try {
            const response = await fetch(
                "https://www.stringsattached.online/hci/api/api/default/users",
                {
                    headers: {
                        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
                    },
    ...
    const fetchConnections = useCallback(async () => {
        try {
            const response = await fetch(
                `https://www.stringsattached.online/hci/api/api/default/connections?fromUserID=${loggedInUserId}`,
                {
                    headers: {
                        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
                    },
    ...
    const fetchCommunities = useCallback(async () => {
        ...
        const response = await fetch(
            `https://www.stringsattached.online/hci/api/api/default/group-members?userID=${userID}`,
            {
              method: "GET",
              headers: {
                "Authorization": `Bearer ${token}`,
    ...
    const handleGroupClick = useCallback(async (group) => {
        ...
        if (group === groupselected) {
            ...
            const response = await fetch(
                `https://www.stringsattached.online/hci/api/api/default/group-members?groupID=${group.id}`,
                {
                  method: "GET",
                  headers: {
                    "Authorization": `Bearer ${token}`,
              ...
              for (let j = 0; j < mem_list.length; j++) {
                const response = await fetch(
                    `https://www.stringsattached.online/hci/api/api/default/posts?authorID=${mem_list[j]}&sort=newest`,
                    {
                      method: "GET",
                      headers: {
                        "Authorization": `Bearer ${token}`,
    ...
    const populateposts = async (id) => {
        ...
        const response3 = await fetch(
            `https://www.stringsattached.online/hci/api/api/default/groups?name=${id}`,
            {
              method: "GET",
              headers: {
                "Authorization": `Bearer ${token}`,
        ...
        const response = await fetch(
            `https://www.stringsattached.online/hci/api/api/default/group-members?groupID=${actualgid}`,
            {
              method: "GET",
              headers: {
                "Authorization": `Bearer ${token}`,
    ...
    const handleaddingmembers = async (e) => {
        ...
        const response = await fetch(
            `https://www.stringsattached.online/hci/api/api/default/users?email=${encodeURIComponent(searchQuery)}`,
            {
              method: "GET",
              headers: {
                "Authorization": `Bearer ${token}`,
    ...
    const handleSubmit = useCallback(async (e) => {
            ...
            const uploadResponse = await fetch(
              ...
              const response2 = await fetch(
                `https://www.stringsattached.online/hci/api/api/default/groups`,
                {
                  method: "POST",
                  headers: {
                    "Authorization": `Bearer ${token}`,
            ...
            const response3 = await fetch(
                `https://www.stringsattached.online/hci/api/api/default/group-members`,
                {
                  method: "POST",
                  headers: {
                    "Authorization": `Bearer ${token}`,
    ...
    const handleunblockingposts = async(id,e) => {
        ...
        const userResponse = await fetch(
          ...
          const postresponse = await fetch (
            `https://www.stringsattached.online/hci/api/api/default/posts/${id}`,
            {
                method: "GET",
              headers: {
                "Authorization": `Bearer ${token}`,

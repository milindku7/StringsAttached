...
const Conversations = () => {
    ...
    const fetchConnections = useCallback(async () => {
        try {
            const response = await fetch(
                `https://stringsattached.online/hci/api/api/claem/connections?fromUserID=${loggedInUserId}`,
                {
                    headers: {
                        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
                    },
    ...
    const fetchCommunities = useCallback(async () => {
        ...
        const response = await fetch(
            `https://stringsattached.online/hci/api/api/claem/group-members?userID=${userID}`,
            {
              method: "GET",
              headers: {
                "Authorization": `Bearer ${token}`,
    ...
    const handleGroupClick = useCallback(async (group) => {
        ...
        if (group === groupselected) {
            ...
            const response = await fetch(
                `https://stringsattached.online/hci/api/api/claem/group-members?groupID=${group.id}`,
                {
                  method: "GET",
                  headers: {
                    "Authorization": `Bearer ${token}`,
              ...
              for (let j = 0; j < mem_list.length; j++) {
                const response = await fetch(
                    `https://stringsattached.online/hci/api/api/claem/posts?authorID=${mem_list[j]}&sort=newest`,
                    {
                      method: "GET",
                      headers: {
                        "Authorization": `Bearer ${token}`,
    ...
    const populateposts = async (id) => {
        ...
        const response3 = await fetch(
            `https://stringsattached.online/hci/api/api/claem/groups?name=${id}`,
            {
              method: "GET",
              headers: {
                "Authorization": `Bearer ${token}`,
        ...
        const response = await fetch(
            `https://stringsattached.online/hci/api/api/claem/group-members?groupID=${actualgid}`,
            {
              method: "GET",
              headers: {
                "Authorization": `Bearer ${token}`,
    ...
    const handleaddingmembers = async (e) => {
        ...
        const response = await fetch(
            `https://stringsattached.online/hci/api/api/claem/users?email=${encodeURIComponent(searchQuery)}`,
            {
              method: "GET",
              headers: {
                "Authorization": `Bearer ${token}`,
    ...
    const handleSubmit = useCallback(async (e) => {
            ...
            const uploadResponse = await fetch(
              ...
              const response2 = await fetch(
                `https://stringsattached.online/hci/api/api/claem/groups`,
                {
                  method: "POST",
                  headers: {
                    "Authorization": `Bearer ${token}`,
            ...
            const response3 = await fetch(
                `https://stringsattached.online/hci/api/api/claem/group-members`,
                {
                  method: "POST",
                  headers: {
                    "Authorization": `Bearer ${token}`,
    ...
    const handleunblockingposts = async(id,e) => {
        ...
        const userResponse = await fetch(
          ...
          const postresponse = await fetch (
            `https://stringsattached.online/hci/api/api/claem/posts/${id}`,
            {
                method: "GET",
              headers: {
                "Authorization": `Bearer ${token}`,
                ...
                {loading ? (
                    ...
                    <div className="users-list-container">
                        ...
                        >
                            {gr.attributes.image && 
                                <img
                            src={"https://stringsattached.online/" + gr.attributes.image}
                            width="100px"
                            alt="Profile"
                        />
                            }

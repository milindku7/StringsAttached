      ...
      uniqueIds.map(async (id) => {
        try {
          const res = await fetch(
            `https://www.stringsattached.online/hci/api/api/default/users/${id}`,
            {
  ...
  const handleSaveName = async () => {
    ...
    try {
      const userRes = await fetch(
        `https://www.stringsattached.online/hci/api/api/default/users/${currentUserId}`,
        {
          headers: {
                  ...
                  <img
                    src={
                      currentUser?.attributes?.profileImage
                        ? `https://www.stringsattached.online${currentUser.attributes.profileImage}`
                        : noIcon
                    }
                    alt="Profile"
                      ...
                      <img
                        src={
                          currentUserProfile?.attributes?.profileImage
                            ? `https://www.stringsattached.online${currentUserProfile.attributes.profileImage}`
                            : noIcon
                        }
                        onError={(e) => {
